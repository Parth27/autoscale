...
public class AutoScaleConfig {
    ...
    public static final String INSTANCE_START = "/home/parth/autoscale/bin/ec2-instance-start.sh";
    public static final String MODEL_FILE = "/home/parth/autoscale/server/src/main/resources/probabilities.txt";
    ...
    public static final long INTERVAL_MINS = 1L;
}
